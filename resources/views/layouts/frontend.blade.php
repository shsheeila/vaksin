                ...
                <div class="container"><a class="navbar-brand" href=""><img src="{{ asset('vaksin/assets/img/gallery/logo.png')}}" width="118" alt="logo" /></a>
                  ...
                  <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
                      ...
                      <li class="nav-item px-2"><a class="nav-link" href="">Info Penting</a></li>
                      <li class="nav-item px-2"><a class="nav-link" href="#berita">Berita</a></li>
                      @if (Auth::guest())
                      <a class="btn btn-sm btn-outline-primary rounded-pill order-1 order-lg-0 ms-lg-4" href="{{ route('login') }}">Login/Register</a>
                      @else
